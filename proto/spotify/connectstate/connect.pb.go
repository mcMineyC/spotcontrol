...
const file_spotify_connectstate_connect_proto_rawDesc = "" +
	"\n" +
	"\"spotify/connectstate/connect.proto\x12\x14spotify.connectstate\x1a!spotify/connectstate/player.proto\x1a2spotify/connectstate/devices/connect_devices.proto\"\xe1\x01\n" +
	"\rClusterUpdate\x127\n" +
	...
	"\x1cstarted_playing_at_timestamp\x18\v \x01(\x04H\x01R\x19startedPlayingAtTimestamp\x88\x01\x01\x12G\n" +
	...
	"\x15is_locally_discovered\x18\x1d \x01(\bR\x13isLocallyDiscovered\x12K\n" +
	"\n" +
	...
	"\x18supports_playlist_mixing\x18$ \x01(\bR\x16supportsPlaylistMixingJ\x04\b\x01\x10\x02J\x04\b\x04\x10\x05J\x04\b\x18\x10\x19J\x04\b\x1f\x10 J\x04\b \x10!\"\x93\x01\n" +
	...
	"\t_alias_idB\x17\n" +
	"\x15_connect_capabilities\"\xce\x02\n" +
	"\aContext\x12\x10\n" +
	...
	"\x06tracks\x18\x04 \x03(\v2\".spotify.connectstate.ContextTrackR\x06tracks\x12\x18\n" +
	"\aloading\x18\x05 \x01(\bR\aloading\x1a;\n" +
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x05queue\x18\x04 \x01(\v2\x1b.spotify.connectstate.QueueR\x05queue\"\xc3\x04\n" +
	"\aSession\x12A\n" +
	...
	"currentUid\x12)\n" +
	"\x10option_overrides\x18\x04 \x01(\x03R\x0foptionOverrides\x12F\n" +
	"\fsuppressions\x18\x05 \x01(\v2\".spotify.connectstate.SuppressionsR\fsuppressions\x12b\n" +
	"\x16instrumentation_params\x18\x06 \x03(\v2+.spotify.connectstate.InstrumentationParamsR\x15instrumentationParams\x12w\n" +
	"\x1econtext_player_option_override\x18\a \x01(\v22.spotify.connectstate.ContextPlayerOptionOverridesR\x1bcontextPlayerOptionOverride\x123\n" +
	"\x13original_session_id\x18\b \x01(\tH\x00R\x11originalSessionId\x88\x01\x01B\x16\n" +
	"\x14_original_session_id\"l\n" +
	"\x15InstrumentationParams\x12'\n" +
	"\x0finteraction_ids\x18\x01 \x03(\tR\x0einteractionIds\x12*\n" +
	"\x11page_instance_ids\x18\x02 \x03(\tR\x0fpageInstanceIds\"\xef\x01\n" +
	"\bPlayback\x12\x1c\n" +
	"\ttimestamp\x18\x01 \x01(\x03R\ttimestamp\x127\n" +
	"\x18position_as_of_timestamp\x18\x02 \x01(\x03R\x15positionAsOfTimestamp\x12%\n" +
	"\x0eplayback_speed\x18\x03 \x01(\x01R\rplaybackSpeed\x12\x1b\n" +
	"\tis_paused\x18\x04 \x01(\bR\bisPaused\x12H\n" +
	"\rcurrent_track\x18\x05 \x01(\v2#.spotify.connectstate.ProvidedTrackR\fcurrentTrack\"n\n" +
	"\x05Queue\x12;\n" +
	"\x06tracks\x18\x01 \x03(\v2#.spotify.connectstate.ProvidedTrackR\x06tracks\x12(\n" +
	"\x10is_playing_queue\x18\x02 \x01(\bR\x0eisPlayingQueue*D\n" +
