...
const file_spotify_keyexchange_proto_rawDesc = "" +
	"\n" +
	"\x19spotify/keyexchange.proto\x12\aspotify\"\xe2\x03\n" +
	"\vClientHello\x121\n" +
	"\n" +
	"build_info\x18\n" +
...
var (
	...
	file_spotify_keyexchange_proto_rawDescData []byte
)

func file_spotify_keyexchange_proto_rawDescGZIP() []byte {
	file_spotify_keyexchange_proto_rawDescOnce.Do(func() {
		file_spotify_keyexchange_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_spotify_keyexchange_proto_rawDesc), len(file_spotify_keyexchange_proto_rawDesc)))
	})
...
func file_spotify_keyexchange_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_spotify_keyexchange_proto_rawDesc), len(file_spotify_keyexchange_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   27,
			NumExtensions: 0,
			NumServices:   0,
